    ...
    <section className="relative flex min-h-screen items-center justify-center overflow-hidden px-6 py-16">
      ...
      >
        ...
        <motion.div
          ...
          className="mb-8 flex h-28 w-28 items-center justify-center rounded-full border border-[#d8b989]/70 bg-white/50 shadow-[0_20px_60px_rgba(93,64,37,0.12)] backdrop-blur"
        >
        ...
        <motion.h1
          ...
          className="font-serif text-5xl leading-tight text-[#2f2a25]"
        >
        ...
        <motion.div
          ...
          className="mt-8 rounded-3xl border border-[#e5cfaa] bg-white/55 px-6 py-5 shadow-[0_18px_60px_rgba(88,63,38,0.12)] backdrop-blur"
        >
